...
$(document).ready(function($) {
	...
	if($('#chartdiv').length > 0) {
		...
		series.riseFromOpenState.properties.fill = am4core.color("#FE3F51");
		series.dropFromOpenState.properties.fill = am4core.color("#0DBF0A");
		series.riseFromOpenState.properties.stroke = am4core.color("#FE3F51");
		series.dropFromOpenState.properties.stroke = am4core.color("#0DBF0A");
	...
	if($('#chartdiv2').length > 0) {
		...
		chart1.legend.valueLabels.template.text = "{valueY.value.formatNumber('$#.')}";
	}
